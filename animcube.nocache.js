function animcube() {
    var O = 'bootstrap', P = 'begin', Q = 'gwt.codesvr.animcube=', R = 'gwt.codesvr=', S = 'animcube', T = 'startup', U = 'DUMMY', V = 0, W = 1, X = 'iframe', Y = 'javascript:""', Z = 'position:absolute; width:0; height:0; border:none; left: -1000px;', $ = ' top: -1000px;', _ = 'CSS1Compat', ab = '<!doctype html>', bb = '', cb = '<html><head><\/head><body><\/body><\/html>', db = 'undefined', eb = 'DOMContentLoaded', fb = 50, gb = 'Chrome', hb = 'eval("', ib = '");', jb = 'script', kb = 'javascript', lb = 'moduleStartup', mb = 'moduleRequested', nb = 'Failed to load ', ob = 'head', pb = 'meta', qb = 'name', rb = 'animcube::', sb = '::', tb = 'gwt:property', ub = 'content', vb = '=', wb = 'gwt:onPropertyErrorFn', xb = 'Bad handler "', yb = '" for "gwt:onPropertyErrorFn"', zb = 'gwt:onLoadErrorFn', Ab = '" for "gwt:onLoadErrorFn"', Bb = '#', Cb = '?', Db = '/', Eb = 'img', Fb = 'clear.cache.gif', Gb = 'baseUrl', Hb = 'animcube.nocache.js', Ib = 'base', Jb = '//', Kb = 'user.agent', Lb = 'webkit', Mb = 'safari', Nb = 'msie', Ob = 10, Pb = 11, Qb = 'ie10', Rb = 9, Sb = 'ie9', Tb = 8, Ub = 'ie8', Vb = 'gecko', Wb = 'gecko1_8', Xb = 2, Yb = 3, Zb = 4, $b = 'selectingPermutation', _b = 'animcube.devmode.js', ac = '7551EE39E21E6204DAB2374363B779A2', bc = 'A6D5F3094E6388396B12A0A9CE8EF2EF', cc = 'AE36935EDCF07BC5D3A8A7EB084B5271', dc = 'B3E80B04426C0273101CD02501E8B9EA', ec = 'E6C667CAF40720B328FF8185FF555CC5', fc = ':', gc = '.cache.js', hc = 'link', ic = 'rel', jc = 'stylesheet', kc = 'href', lc = 'loadExternalRefs', mc = 'gwt/clean/clean.css', nc = 'end', oc = 'http:', pc = 'file:', qc = '_gwt_dummy_', rc = '__gwtDevModeHook:animcube', sc = 'Ignoring non-whitelisted Dev Mode URL: ', tc = ':moduleBase';
    var o = window;
    var p = document;
    r(O, P);
    function q() {
    ...
    animcube.__sendStats = r;
    animcube.__moduleName = S;
    animcube.__errFn = null;
    animcube.__moduleBase = U;
    animcube.__softPermutationId = V;
    ...
    animcube.__moduleStartupDone = function(e) {
        var f = t[S].bindings;
        t[S].bindings = function() {
            var a = f ? f(): {};
            var b = e[animcube.__softPermutationId];
    ...
    function A(k) {
        ...
        animcube.onScriptDownloaded = function(a) {
            l(function() {
                m(a)
            })
        };
        ...
        if (animcube.__errFn) {
            n.onerror = function() {
                animcube.__errFn(S, new Error(nb + code))
            }
        }
        p.getElementsByTagName(ob)[V].appendChild(n)
    }
    animcube.__startLoadingFragment = function(a) {
        return D(a)
    };
    animcube.__installRunAsyncCode = function(a) {
        var b = v();
        var c = b.body;
    ...
    function D(a) {
        ...
        return animcube.__moduleBase + a
    }
    function F() {
        var f = [];
        var g = V;
        ...
        animcube.__computePropValue = k;
        o.__gwt_activeModules[S].bindings = animcube.__getPropMap;
        r(O, $b);
        if (q()) {
            return D(_b)
        }
        ...
        animcube.__softPermutationId = g;
        return D(l + gc)
    }
    function G() {
    ...
    B();
    animcube.__moduleBase = C();
    t[S].moduleBase = animcube.__moduleBase;
    var H = F();
    if (o) {
