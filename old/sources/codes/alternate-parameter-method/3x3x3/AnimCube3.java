package com.google.gwt.animcube3.client;
...
public final class AnimCube3 implements EntryPoint {
...
//  private boolean outlined = true;
  ...
  private static String cubeDivName = "cube3";
  ...
  private int[] getMovePart(String sequence, boolean info) {
    ...
    String moveCodeString = "UDFBLRESMXYZxyzudfblr";
    if (yzAlt == true)
  ...
  public void init2 (){
    if (firstTime) {
      ...
      if (cubeDiv == null)
        ...
        canv.getElement().setId("animCanv3");
