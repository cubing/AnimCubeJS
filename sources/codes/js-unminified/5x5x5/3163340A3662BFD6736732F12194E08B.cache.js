...
var $strongName = '3163340A3662BFD6736732F12194E08B';
var $gwt = {};
...
function $init(this$static){
  ...
  $addDomHandler(get_0(), new AnimCube5$6, ($clinit_ContextMenuEvent() , $clinit_ContextMenuEvent() , TYPE));
...
_.utextHeight = 0;
_.width_0 = 0;
var adjacentFaces, areaDirs, border, borderWidth = 0, botBlockFaceDim, buttonAction, cornerCoords, cubeBlocks, dph = 0, dpr = 0, dragBlocks, faceCorners, faceNormals, faceTwistDirs, factors, isGecko = false, lineWidth_0 = 0, metricChar, midBlockFaceDim, midBlockFaceDim2, midBlockFaceDim3, midBlockTable, modeChar, modifierStrings, moveCodes, moveModes, oppositeCorners, posFaceTransform, posFaceletTransform, randMoveCount = 0, rotCos, rotSign, rotSin, rotVec, scramble = 0, scrambleToggle = false, scw = 0, snap = false, superCube = false, textOffset, textOffsetInit, topBlockFaceDim, topBlockTable, turnSymbol, twistDirs, ww = false;
...
function $onPreviewNativeEvent(this$static, event_0){
  ...
  if (eventType == $intern_11) {
    ...
    ($clinit_AnimCube5() , isGecko) && $eventPreventDefault(event_0.nativeEvent);
    this$static.this$01.mouseIsDown = true;
    $mouseDown(this$static.this$01, event_0);
  }
}
...
defineClass(145, 54, $intern_31, RootPanel$DefaultRootPanel);
...
defineClass(51, 18, $intern_15, ArrayStoreException);
...
defineClass(48, 18, $intern_15, IllegalStateException);
...
defineClass(49, 18, $intern_15, NoSuchElementException);
