...
var $strongName = '4B68D9B1017E2E03FF53777644C14EBB';
var $gwt = {};
...
function $drawMoveText(this$static, g, y_0){
  ...
  if (w2 > 0) {
    ...
    $setStrokeStyleWeb(g, 'black');
    $beginPath(g);
    this$static.utextHeight <= 14?$fillRect(g, x_0 + w1 - 1, this$static.height_0 - this$static.progressHeight - this$static.textHeight - round_int(dpr * 4), w2 + 2, this$static.textHeight + round_int(dpr) * 3):$fillRect(g, x_0 + w1 - 1, this$static.height_0 - this$static.progressHeight - this$static.textHeight - round_int(dpr * 2), w2 + 2, this$static.textHeight + round_int(dpr));
  }
...
function $getParameter(this$static, name_0){
  ...
  parameter = (ensureListParameterMap() , paramsForName = dynamicCast(listParamMap.get_0(name_0), 20) , !paramsForName?null:dynamicCastToString(paramsForName.get_1(paramsForName.size_1() - 1)));
  if (parameter == null)
...
function $init(this$static){
  ...
  $addDomHandler(get_0(), new AnimCube6$6, ($clinit_ContextMenuEvent() , $clinit_ContextMenuEvent() , TYPE));
  ...
  if (!(scramble > 0 && this$static.buttonBar == 2)) {
    if (!this$static.demo && this$static.move.length > 0) {
      ...
      if (this$static.move.length > 1) {
        ...
        $drawString(this$static, this$static.graphics, s, x_0, this$static.utextHeight < 10?round_int(10 * dpr):this$static.utextHeight < 12?round_int(12 * dpr):this$static.utextHeight < 14?round_int(14 * dpr):this$static.textHeight);
    ...
    if (this$static.curInfoText >= 0) {
      $setFont(this$static.graphics, 'bold ' + this$static.textHeight + 'px helvetica');
      $drawString(this$static, this$static.graphics, this$static.infoText[this$static.curInfoText], 0, this$static.utextHeight < 10?round_int(10 * dpr):this$static.utextHeight < 12?round_int(12 * dpr):this$static.utextHeight < 14?round_int(14 * dpr):this$static.textHeight);
    }
  }
...
_.utextHeight = 0;
_.width_0 = 0;
var adjacentFaces, areaDirs, border, borderWidth = 0, botBlockFaceDim, buttonAction, cornerCoords, cubeBlocks, dph = 0, dpr = 0, dragBlocks, faceCorners, faceNormals, faceTwistDirs, factors, isGecko = false, lineWidth_0 = 0, metricChar, midBlockFaceDim, midBlockFaceDim2, midBlockFaceDim3, midBlockFaceDim4, midBlockTable, modeChar, modifierStrings, moveCodes, moveModes, oppositeCorners, posFaceTransform, posFaceletTransform, randMoveCount = 0, rotCos, rotSign, rotSin, rotVec, scramble = 0, scrambleToggle = false, scw = 0, snap = false, superCube = false, textOffset, textOffsetInit, topBlockFaceDim, topBlockTable, turnSymbol, twistDirs, ww = false;
...
function $onPreviewNativeEvent(this$static, event_0){
  ...
  if (eventType == $intern_12) {
    ...
    ($clinit_AnimCube6() , isGecko) && $eventPreventDefault(event_0.nativeEvent);
    this$static.this$01.mouseIsDown = true;
    $mouseDown(this$static.this$01, event_0);
  }
}
...
defineClass(50, 1, {29:1}, HandlerManager, HandlerManager_0);
var Lcom_google_gwt_event_shared_HandlerManager_2_classLit = createForClass('com.google.gwt.event.shared', 'HandlerManager', 50);
defineClass(197, 1, {});
...
defineClass(66, 50, {29:1}, Window$WindowHandlers);
...
function get_0(){
  $clinit_RootPanel();
  var rp;
  rp = dynamicCast($get(rootPanels, null), 54);
  if (rp) {
    return rp;
  }
...
defineClass(54, 141, $intern_32);
var maybeDetachCommand, rootPanels, widgetsToDetach;
var Lcom_google_gwt_user_client_ui_RootPanel_2_classLit = createForClass('com.google.gwt.user.client.ui', 'RootPanel', 54);
...
defineClass(145, 54, $intern_32, RootPanel$DefaultRootPanel);
...
defineClass(51, 18, $intern_16, ArrayStoreException);
...
defineClass(48, 18, $intern_16, IllegalStateException);
var Ljava_lang_IllegalStateException_2_classLit = createForClass('java.lang', 'IllegalStateException', 48);
...
defineClass(52, 75, {201:1}, StringBuilder);
...
defineClass(49, 18, $intern_16, NoSuchElementException);
