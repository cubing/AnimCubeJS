...
Check out the demo and source code to see how the applet works. Make sure to include `animcube.nocache.js`, `AnimCube.cfg`, and all `[long alphanumeric string].cache.js` in the directory/folder referenced in cube.html (as the src for animcube.nocache.js). DO NOT CHANGE THE NAMES OF THE NON-CFG FILES.
