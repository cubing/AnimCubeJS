...
var $strongName = 'CA9F552599F0D56E33C60DEEE2E9EFE9';
var $gwt = {};
...
;
stringCastMap = {3:1, 184:1, 183:1, 2:1};
modernizeBrowser();
...
defineClass(158, 1, {});
var instance;
var Lcom_google_gwt_animation_client_AnimationScheduler_2_classLit = createForClass('com.google.gwt.animation.client', 'AnimationScheduler', 158);
...
defineClass(65, 158, {}, AnimationSchedulerImplStandard);
...
defineClass(148, 57, {57:1}, AnimationSchedulerImplStandard$1);
var Lcom_google_gwt_animation_client_AnimationSchedulerImplStandard$1_2_classLit = createForClass('com.google.gwt.animation.client', 'AnimationSchedulerImplStandard/1', 148);
function $updateAnimations(this$static){
  var curAnimations, duration, requestId, requestId$index, requestId$max;
  curAnimations = initDim(Lcom_google_gwt_animation_client_AnimationSchedulerImplTimer$AnimationHandleImpl_2_classLit, {187:1, 3:1, 5:1}, 63, this$static.animationRequests.array.length, 0, 1);
  curAnimations = dynamicCast($toArray(this$static.animationRequests, curAnimations), 187);
...
defineClass(66, 158, {}, AnimationSchedulerImplTimer);
...
defineClass(149, 79, {}, AnimationSchedulerImplTimer$1);
_.run = function run(){
  $updateAnimations(this.this$01);
}
;
var Lcom_google_gwt_animation_client_AnimationSchedulerImplTimer$1_2_classLit = createForClass('com.google.gwt.animation.client', 'AnimationSchedulerImplTimer/1', 149);
...
defineClass(84, 1, {67:1, 154:1}, AnimCube$1);
...
defineClass(89, 1, {159:1, 67:1}, AnimCube$6);
...
defineClass(102, 175, $intern_15, Canvas_0);
var detector;
var Lcom_google_gwt_canvas_client_Canvas_2_classLit = createForClass('com.google.gwt.canvas.client', 'Canvas', 102);
defineClass(176, 1, {});
var Lcom_google_gwt_canvas_client_Canvas$CanvasElementSupportDetector_2_classLit = createForClass('com.google.gwt.canvas.client', 'Canvas/CanvasElementSupportDetector', 176);
function Canvas$CanvasElementSupportDetectedMaybe(){
}

defineClass(103, 176, {}, Canvas$CanvasElementSupportDetectedMaybe);
...
defineClass(157, 1, {});
var Lcom_google_gwt_core_client_Scheduler_2_classLit = createForClass('com.google.gwt.core.client', 'Scheduler', 157);
...
defineClass(132, 157, {}, SchedulerImpl);
_.flushRunning = false;
_.shouldBeRunning = false;
var INSTANCE;
var Lcom_google_gwt_core_client_impl_SchedulerImpl_2_classLit = createForClass('com.google.gwt.core.client.impl', 'SchedulerImpl', 132);
function SchedulerImpl$Flusher(this$0){
  this.this$01 = this$0;
}

defineClass(133, 1, {}, SchedulerImpl$Flusher);
...
;
var Lcom_google_gwt_core_client_impl_SchedulerImpl$Flusher_2_classLit = createForClass('com.google.gwt.core.client.impl', 'SchedulerImpl/Flusher', 133);
function SchedulerImpl$Rescuer(this$0){
  this.this$01 = this$0;
}

defineClass(134, 1, {}, SchedulerImpl$Rescuer);
_.execute_1 = function execute_4(){
  this.this$01.flushRunning && scheduleFixedDelayImpl(this.this$01.flusher, 1);
  return this.this$01.shouldBeRunning;
}
;
var Lcom_google_gwt_core_client_impl_SchedulerImpl$Rescuer_2_classLit = createForClass('com.google.gwt.core.client.impl', 'SchedulerImpl/Rescuer', 134);
...
function dropInternalFrames(stackTrace){
  ...
  for (i = 0; i < numberOfFrameToSearch; i++) {
    if ($equals(stackTrace[i].methodName, dropFrameUntilFnName)) {
      return dynamicCast((stackTrace.length >= i + 1 && stackTrace.splice(0, i + 1) , stackTrace), 153);
    }
  }
  return stackTrace;
}
...
defineClass(95, 170, {}, StackTraceCreator$CollectorLegacy);
...
defineClass(96, 171, {}, StackTraceCreator$CollectorModernNoSourceMap);
...
;
var Lcom_google_web_bindery_event_shared_Event_2_classLit = createForClass('com.google.web.bindery.event.shared', 'Event', 156);
...
;
_.dead = false;
var Lcom_google_gwt_event_shared_GwtEvent_2_classLit = createForClass('com.google.gwt.event.shared', 'GwtEvent', 155);
...
;
var registered;
var Lcom_google_gwt_event_dom_client_DomEvent_2_classLit = createForClass('com.google.gwt.event.dom.client', 'DomEvent', 182);
...
defineClass(143, 182, {}, ContextMenuEvent);
_.dispatch = function dispatch(handler){
  $dispatch(this, dynamicCast(handler, 159));
}
;
var TYPE;
var Lcom_google_gwt_event_dom_client_ContextMenuEvent_2_classLit = createForClass('com.google.gwt.event.dom.client', 'ContextMenuEvent', 143);
defineClass(92, 1, {});
...
defineClass(147, 1, {}, PrivateMap);
var Lcom_google_gwt_event_dom_client_PrivateMap_2_classLit = createForClass('com.google.gwt.event.dom.client', 'PrivateMap', 147);
...
defineClass(150, 155, {}, CloseEvent_0);
_.dispatch = function dispatch_0(handler){
  dynamicCast(handler, 186);
  detachWidgets();
}
;
...
;
var TYPE_0;
var Lcom_google_gwt_event_logical_shared_CloseEvent_2_classLit = createForClass('com.google.gwt.event.logical.shared', 'CloseEvent', 150);
...
defineClass(179, 1, {});
var Lcom_google_web_bindery_event_shared_EventBus_2_classLit = createForClass('com.google.web.bindery.event.shared', 'EventBus', 179);
  ...
  if (this$static.deferredDeltas) {
    try {
      for (c$iterator = new AbstractList$IteratorImpl(this$static.deferredDeltas); c$iterator.i < c$iterator.this$01_0.size_1();) {
        c = (checkCriticalElement(c$iterator.i < c$iterator.this$01_0.size_1()) , dynamicCast(c$iterator.this$01_0.get_1(c$iterator.i++), 185));
...
defineClass(146, 1, {}, LegacyHandlerWrapper);
var Lcom_google_gwt_event_shared_LegacyHandlerWrapper_2_classLit = createForClass('com.google.gwt.event.shared', 'LegacyHandlerWrapper', 146);
...
defineClass(180, 1, {});
var Lcom_google_gwt_http_client_Response_2_classLit = createForClass('com.google.gwt.http.client', 'Response', 180);
defineClass(123, 180, {});
...
defineClass(144, 24, $intern_19, RequestPermissionException);
...
defineClass(152, 24, $intern_19, RequestTimeoutException);
var Lcom_google_gwt_http_client_RequestTimeoutException_2_classLit = createForClass('com.google.gwt.http.client', 'RequestTimeoutException', 152);
...
function fromInt(value_0){
  ...
  if (value_0 > -129 && value_0 < 128) {
    rebase = value_0 + 128;
    boxedValues == null && (boxedValues = initDim(Lcom_google_gwt_lang_LongLibBase$LongEmul_2_classLit, $intern_24, 198, 256, 0, 1));
...
defineClass(91, 155, {}, Event$NativePreviewEvent);
_.dispatch = function dispatch_1(handler){
  $dispatch_0(this, dynamicCast(handler, 154));
}
;
...
defineClass(116, 155, {}, Window$ClosingEvent);
...
defineClass(135, 181, $intern_15);
_.iterator = function iterator_0(){
  return new WidgetCollection$WidgetIterator(this.children);
}
;
var Lcom_google_gwt_user_client_ui_ComplexPanel_2_classLit = createForClass('com.google.gwt.user.client.ui', 'ComplexPanel', 135);
...
defineClass(137, 81, $intern_18, AttachDetachException);
...
defineClass(141, 1, {}, RootPanel$1);
_.execute_2 = function execute_7(w){
  w.attached && $onDetach(w);
}
;
var Lcom_google_gwt_user_client_ui_RootPanel$1_2_classLit = createForClass('com.google.gwt.user.client.ui', 'RootPanel/1', 141);
function RootPanel$2(){
}

defineClass(142, 1, {186:1, 67:1}, RootPanel$2);
var Lcom_google_gwt_user_client_ui_RootPanel$2_2_classLit = createForClass('com.google.gwt.user.client.ui', 'RootPanel/2', 142);
function RootPanel$DefaultRootPanel(){
  RootPanel.call(this, $doc.body);
}

defineClass(140, 51, $intern_30, RootPanel$DefaultRootPanel);
var Lcom_google_gwt_user_client_ui_RootPanel$DefaultRootPanel_2_classLit = createForClass('com.google.gwt.user.client.ui', 'RootPanel/DefaultRootPanel', 140);
...
defineClass(120, 1, {185:1}, SimpleEventBus$2);
...
defineClass(31, 68, {3:1, 183:1, 31:1, 68:1}, Integer);
...
defineClass(49, 70, {184:1}, StringBuilder);
...
;
var Ljava_util_AbstractCollection_2_classLit = createForClass('java.util', 'AbstractCollection', 173);
...
defineClass(32, 174, $intern_31, AbstractHashMap$EntrySet);
...
;
var Ljava_util_AbstractList_2_classLit = createForClass('java.util', 'AbstractList', 177);
...
defineClass(71, 174, $intern_31, AbstractMap$1);
...
;
var Ljava_util_AbstractMapEntry_2_classLit = createForClass('java.util', 'AbstractMapEntry', 178);
...
defineClass(27, 177, $intern_33, ArrayList);
...
defineClass(104, 177, $intern_33, Collections$EmptyList);
...
defineClass(108, 107, $intern_31, Collections$UnmodifiableMap$UnmodifiableEntrySet);
...
defineClass(109, 1, $intern_32, Collections$UnmodifiableMap$UnmodifiableEntrySet$UnmodifiableEntry);
...
defineClass(151, 16, $intern_16, ConcurrentModificationException);
var Ljava_util_ConcurrentModificationException_2_classLit = createForClass('java.util', 'ConcurrentModificationException', 151);
...
defineClass(62, 174, {3:1, 36:1}, HashSet);
...
defineClass(131, 1, {}, InternalJsHashCodeMap$1);
...
_.itemIndex = 0;
_.lastEntry = null;
var Ljava_util_InternalJsHashCodeMap$1_2_classLit = createForClass('java.util', 'InternalJsHashCodeMap/1', 131);
function InternalJsHashCodeMap$InternalJsHashCodeMapLegacy(){
  InternalJsHashCodeMap.call(this);
}

defineClass(129, 80, {}, InternalJsHashCodeMap$InternalJsHashCodeMapLegacy);
...
;
var Ljava_util_InternalJsHashCodeMap$InternalJsHashCodeMapLegacy_2_classLit = createForClass('java.util', 'InternalJsHashCodeMap/InternalJsHashCodeMapLegacy', 129);
function InternalJsHashCodeMap$InternalJsHashCodeMapLegacy$1(this$1){
  this.this$11 = this$1;
  ArrayList.call(this);
}

defineClass(130, 27, $intern_33, InternalJsHashCodeMap$InternalJsHashCodeMapLegacy$1);
...
;
var Ljava_util_InternalJsHashCodeMap$InternalJsHashCodeMapLegacy$1_2_classLit = createForClass('java.util', 'InternalJsHashCodeMap/InternalJsHashCodeMapLegacy/1', 130);
function InternalJsMapFactory(){
}

defineClass(126, 1, {}, InternalJsMapFactory);
...
;
var Ljava_util_InternalJsMapFactory_2_classLit = createForClass('java.util', 'InternalJsMapFactory', 126);
...
defineClass(128, 126, {}, InternalJsMapFactory$KeysWorkaroundJsMapFactory);
_.createJsStringMap = function createJsStringMap_0(){
  return new InternalJsStringMap$InternalJsStringMapWithKeysWorkaround;
}
;
var Ljava_util_InternalJsMapFactory$KeysWorkaroundJsMapFactory_2_classLit = createForClass('java.util', 'InternalJsMapFactory/KeysWorkaroundJsMapFactory', 128);
function InternalJsMapFactory$LegacyInternalJsMapFactory(){
}

defineClass(127, 126, {}, InternalJsMapFactory$LegacyInternalJsMapFactory);
...
;
var Ljava_util_InternalJsMapFactory$LegacyInternalJsMapFactory_2_classLit = createForClass('java.util', 'InternalJsMapFactory/LegacyInternalJsMapFactory', 127);
...
defineClass(77, 178, $intern_32, InternalJsStringMap$2);
...
defineClass(114, 27, $intern_33, InternalJsStringMap$InternalJsStringMapLegacy$1);
...
var D_classLit = createForPrimitive('double', 'D'), I_classLit = createForPrimitive('int', 'I'), C_classLit = createForPrimitive('char', 'C'), Lcom_google_gwt_lang_CollapsedPropertyHolder_2_classLit = createForClass('com.google.gwt.lang', 'CollapsedPropertyHolder', 161), Lcom_google_gwt_lang_JavaClassHierarchySetupUtil_2_classLit = createForClass('com.google.gwt.lang', 'JavaClassHierarchySetupUtil', 163), Lcom_google_gwt_lang_LongLibBase$LongEmul_2_classLit = createForClass('com.google.gwt.lang', 'LongLibBase/LongEmul', null), Lcom_google_gwt_lang_ModuleUtils_2_classLit = createForClass('com.google.gwt.lang', 'ModuleUtils', 166), Ljava_util_Map$Entry_2_classLit = createForInterface('java.util', 'Map/Entry');
